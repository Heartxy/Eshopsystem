...
<td><a href="${pageContext.request.contextPath}/servlet/ProductTypeServlet?method=update&id=${item.id}">修改</a></td>
<td><a href="${pageContext.request.contextPath}/servlet/ProductTypeServlet?method=delete&id=${item.id}">删除</a></td>
</tr>
</c:forEach>
</table>
</div>
